...
1. Integrate SB Admin 2 Dashbaord Theme
2. New workouts Page/Edit, New Exercise Page/Edit
   a. Need to finish ajax search and paginate feature on new workout. Search form doesn't work in render/ exercises div
3. Attempting to add additional exercises ,, added code for ajax requests but likely won't work.
