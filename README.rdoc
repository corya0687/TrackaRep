...
5. Build Run feature.
  ...
  Sprint Log-- Need to figure out where how to get api call to exercise to go to run screen
6. Build index page.
...
1. Edit and New w validation errors workout forms-
 ...
 ii.Check boxes in table not responding to workout js in rightside panel div
